...
# Import your BPE implementation
...
def run_embedding(
    ...
    embedd.load_state_dict({"weight": weights})
...
def run_multihead_self_attention(
    ...
    return mha(in_features, rope=None, token_positions=None)
...
def run_transformer_block(
    ...
    # 将参考实现的 state_dict key 映射到我们的 Module
...
def run_transformer_lm(
    ...
    for i in range(num_layers):
        state_dict[f"layers.{i}.attn.q_proj"] = weights[f"layers.{i}.attn.q_proj.weight"]
        state_dict[f"layers.{i}.attn.k_proj"] = weights[f"layers.{i}.attn.k_proj.weight"]
        state_dict[f"layers.{i}.attn.v_proj"] = weights[f"layers.{i}.attn.v_proj.weight"]
        state_dict[f"layers.{i}.attn.o_proj"] = weights[f"layers.{i}.attn.output_proj.weight"]
